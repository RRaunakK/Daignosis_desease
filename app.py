...
background_image_url = "https://img.freepik.com/premium-photo/photo-medical-equipment_931878-163149.jpg?w=900"  # Replace with your image URL
...
models = {
    'diabetes': pickle.load(open('C:/Users/HP/Work/Desease Daignosis/Disease Daigonsis/daibetes_model.sav', 'rb')),
    'heart_disease': pickle.load(open('C:/Users/HP/Work/Desease Daignosis/Disease Daigonsis/heart_disease_model.sav', 'rb')),
    'parkinsons': pickle.load(open('C:/Users/HP/Work/Desease Daignosis/Disease Daigonsis/parkinsons_model.sav', 'rb')),
    'lung_cancer': pickle.load(open('C:/Users/HP/Work/Desease Daignosis/Disease Daigonsis/lungs_disease_model.sav', 'rb')),
    'thyroid': pickle.load(open('C:/Users/HP/Work/Desease Daignosis/Disease Daigonsis/Thyroid_model.sav', 'rb'))
}
